...
ENERGY_STOCKS = {
    'brown': [
        'TTD',   # ExxonMobil - Integrated Oil
        'PLTR',   # Chevron - Integrated Oil
        'CRWD',   # ConocoPhillips - E&P
        'ODFL',   # Schlumberger - Services
        'DDOG',   # EOG Resources - E&P
        'COIN',   # Phillips 66 - Refining
        'ABNB',   # Valero - Refining
        'AXON',   # Marathon Petroleum - Refining
        'CHTR',   # Occidental - E&P
        'MNST',   # Halliburton - Services
        
    ],
    'green': [
        'INTC',   # NextEra Energy - Utility + Renewables
        'WBA',  # First Solar - Solar Manufacturing
        'NXPI',  # Enphase - Solar Inverters
        'MSFT',  # SolarEdge - Solar Inverters
        'CDNS',   # Sunrun - Residential Solar
        'BKR',   # AES Corporation - Renewable Utility
        'GILD',   # Brookfield Renewable - Pure-play Renewables
        'HAS',  # Clearway Energy - Renewables
        'TSCO',  # Plug Power - Hydrogen
        'BIIB',    # Bloom Energy - Fuel Cells
